<section id="view-home" class="view-section hidden flex-col items-center flex-1 px-4 w-full max-w-5xl mx-auto py-4 animate-fade-in">
            <div class="w-full text-left mb-6 px-2">
                <h1 class="text-3xl font-bold text-gray-900">Edukasi dan Pantangan Diabetes</h1>
            </div>

            <!-- Edukasi Diabetes Box -->
            <div class="bg-[#9c99c7] p-2 rounded-[2rem] w-full shadow-lg mb-8 hover:shadow-xl transition-shadow duration-300">
                <div class="bg-white rounded-[1.8rem] p-6 md:p-10 flex flex-col md:flex-row gap-8 items-center border border-gray-100">
                    <div class="flex-shrink-0">
                        <h2 class="text-2xl text-gray-800 font-light mb-6">Edukasi Diabetes</h2>
                        <!-- Ilustrasi Placeholder (Menggunakan Icon/CSS) -->
            ...
            <div class="bg-[#9c99c7] p-2 rounded-[2rem] w-full shadow-lg hover:shadow-xl transition-shadow duration-300 animate-slide-up" style="animation-delay: 0.1s;">
                <div class="bg-white rounded-[1.8rem] p-6 md:p-10 border border-gray-100">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="bg-[#f3cce3] rounded-3xl p-6 text-center shadow-sm hover:shadow-md hover:-translate-y-2 transition-all duration-300 group" style="animation-delay: 0.1s;">
                            <div class="w-full h-32 bg-white rounded-xl mb-4 overflow-hidden relative">
                        ...
                        <!-- Kartu Terlalu Asin -->
                        <div class="bg-[#f3cce3] rounded-3xl p-6 text-center shadow-sm hover:shadow-md hover:-translate-y-2 transition-all duration-300 group" style="animation-delay: 0.2s;">
                            <div class="w-full h-32 bg-white rounded-xl mb-4 overflow-hidden relative">
