<section id="view-cekDini" class="view-section hidden flex-col items-center flex-1 px-4 w-full max-w-5xl mx-auto py-4 animate-fade-in">
            ...
            <div class="bg-[#9c99c7] p-8 md:p-10 rounded-[2rem] w-full shadow-2xl hover:shadow-[0_20px_50px_rgba(0,0,0,0.15)] transition-shadow duration-300">
                <div class="space-y-6">
                    
                    <div class="animate-slide-up" style="animation-delay: 0.1s">
                        <label class="block text-gray-900 font-bold mb-2">Berapa usia Anda saat ini?</label>
                        <input type="text" placeholder="Isi jawaban Anda" class="w-full px-5 py-3.5 rounded-xl border-none outline-none bg-white shadow-sm focus:ring-4 focus:ring-white/50 transition-all text-gray-700" />
                    </div>
                    ...
                    <div class="animate-slide-up" style="animation-delay: 0.2s">
                        ...
                        <div class="relative">
                            <select class="w-full px-5 py-3.5 rounded-xl border-none outline-none appearance-none bg-white text-gray-500 cursor-pointer shadow-sm focus:ring-4 focus:ring-white/50 transition-all">
                    ...
                    <div class="pt-8 flex justify-center animate-slide-up" style="animation-delay: 0.8s">
                        <button onclick="navigateTo('hasilAnalisis')" class="bg-[#6b4cde] text-white font-bold px-12 py-4 rounded-xl w-full md:w-auto md:min-w-[400px] hover:bg-blue-700 hover:shadow-xl active:scale-95 hover:-translate-y-1 transition-all duration-200">
